...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="danger" onClick={() => setMenuSelected(true)}>Login</Button>&nbsp;&nbsp;
            <Button variant="danger" onClick={() => setMenuSelected(false)}>SignUp Now</Button>

            <br /> <br />

            {selectedComponentUI}
            <br /> <br />
            <Button variant="danger" onClick={() => { auth.login(() => { bypassLogin(props, 'superadmin') }); }}>ByPass Super Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="danger" onClick={() => { auth.login(() => { bypassLogin(props, 'catererRole') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="danger" onClick={() => { auth.login(() => { bypassLogin(props, 'cateringUserRole') }); }}>ByPass Consumer Login</Button>{' '}
    ...
    function bypassLogin(props, loginType) {
        ...
        } else if ('catererRole' === loginType) {
            email = 'saicaterers@gmail.com'
        }
