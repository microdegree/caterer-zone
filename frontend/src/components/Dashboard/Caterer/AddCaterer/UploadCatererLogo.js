...
const UploadCatererLogo = (props) => {
    ...
    return (
        <div>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#0B5F05',marginTop:'50px' }}>
                    <Card.Body>
                        <Card.Title style={{ color:'#fff' }}>Upload Caterer Image</Card.Title>
...
export default UploadCatererLogo
