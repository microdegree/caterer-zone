    ...
    return (
        ...
        <div style={{ fontWeight: "bold" }}>
            <center>
                <Row>
                    <Col>
                        <Card style={{ width: '38rem', border: '#fff' }}>
                            <br />
                            <center>
                                <Col>
                                    <Card.Img variant="top" src={'../' + props.location.projectData.imageName} style={{ padding: 10, height: '300px', width: '300px' }} />
                                </Col>
                                ...
                                <Row>projectData Details
                                    <Link to={{
                                        ...
                                        &nbsp;  &nbsp;  &nbsp; <Button variant="danger">Check Out</Button></Link>
                                </Row>
                            </center>
                        </Card>
                    </Col>
                    ...
                    <Col>
                        <Card style={{ width: '28rem', border: '#fff' }}>
                            <br />
