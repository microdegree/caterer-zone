...
const Confirmation = (props) => {
    return (
        <div>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#0B5F05' }}><Card.Body>
                    <Card.Title style={{ color:'#fff' }}>Confirmation Page</Card.Title>
                    <Card.Text>

                    </Card.Text>
                    <Row>
                        <Col style={{ color:'#fff',padding:20 }}>
...
Total Cost - {props.location.bookingInfo.finalPrice}
                    ...
                    <Button variant="danger"><Link to='/userDashboard/paymentsGateway' style={{ color: '#fff' }} onClick={confirmBookingAtServer}>Confirm Booking</Link></Button>
